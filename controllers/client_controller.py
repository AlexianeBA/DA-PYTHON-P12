...
def get_clients_filtered(nom_complet: Optional[str] = None) -> Client:
    """
...
def get_clients_filter_by_collaborateur(collaborateur_id: int)-> Client:
    """
